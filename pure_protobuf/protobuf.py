...
class TypeMetadataType(Type):
    ...
    def __init__(self):
        ...
        self.__field_metadata_type.add_field(
            5, 'embedded', EmbeddedMessage(self)
        )  # Used to describe embedded messages.
        # Metadata message description.
        self.__self_type = EmbeddedMessage(MessageType())
        self.__self_type.message_type.add_field(
            1,
            'fields',
            EmbeddedMessage(self.__field_metadata_type),
    ...
    def __create_message(self, message_type):
        ...
        for field in iter(message_type):
            ...
            field_meta.tag, field_meta.name, field_type, field_meta.flags = (
                field
            )
            ...
            if isinstance(field_type, EmbeddedMessage):
                ...
                field_meta.embedded_metadata = self.__create_message(
    ...
    def __restore_type(self, message):
        ...
        for field in message.fields:
            ...
            if field.flags & Flags.EMBEDDED_MASK == Flags.EMBEDDED:
                ...
                field_info[2] = EmbeddedMessage(
                    self.__restore_type(field.embedded)
                )
